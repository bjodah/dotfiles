...
sudo apt-get --assume-yes --no-install-recommends install \
    clang-12 libllvm11 libclang-12-dev lldb-12 llvm-12 llvm-12-dev llvm-12-runtime clang-format-12 clang-tidy-12 libomp-12-dev libclang-12-dev libclang-common-12-dev
