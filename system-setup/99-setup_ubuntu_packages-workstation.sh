sudo apt-get --assume-yes --no-install-recommends install apt-file nvidia-cuda-toolkit gimp iotop docker.io aufs-tools libsfml-dev podman python3-pyglet python3-pygame-sdl2 kdenlive gocryptfs kitty trickle qemu-system-ppc64 qemu-utils cloud-image-utils
