...
sudo apt-get --assume-yes --no-install-recommends install \
     automake bat bc bear biber binutils-dev bison ca-certificates ccache cm-super cmake coinor-libipopt-dev cppcheck \
     ...
     xorg-dev xutils-dev xz-utils zip zlib1g-dev zstd
