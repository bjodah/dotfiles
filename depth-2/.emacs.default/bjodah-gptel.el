(use-package gptel
  ...
  (setq
   ...
   gptel-backend (gptel-make-gemini "Gemini"
                   :key (lambda () (getenv "GEMINI_API_KEY")) ;(lambda () (shell-command-to-string "cat ~/doc/it/*nycklar*/g-gmni.* | tail -c+19 | head -c 39"))
                   :stream t))
...
(gptel-make-openai "Groq"
  ...
  :stream t
  :key (lambda () (getenv "GROQ_API_KEY")) ;(lambda () (shell-command-to-string "cat ~/doc/it/*nycklar*/grq-min-nyckel-16feb.txt | tail -c+19 | head -c -6"))
...
(gptel-make-openai "xAI"           ;Any name you want
  :host "api.x.ai"
  :key (lambda () (getenv "XAI_API_KEY")) ;(lambda () (shell-command-to-string "cat ~/doc/it/*nycklar*/xai-2025-feb.*"))
